...
return {
    ...
    keys = {
        ...
        { "<leader><space>", function() Snacks.picker.resume() end,                                   desc = "恢复搜索" },
        -- { "<leader>,", function() Snacks.picker.buffers() end, desc = "Buffers" },
        -- { "<leader>/", function() Snacks.picker.grep() end, desc = "Grep" },
        -- { "<leader>:", function() Snacks.picker.command_history() end, desc = "Command History" },
        { "<leader>n",       function() Snacks.picker.notifications() end,                           desc = "历史通知" },
        { "<leader>e",       function() Snacks.explorer() end,                                       desc = "资源管理器" },
        -- find
        ...
        { "<leader>gf",      function() Snacks.picker.git_log_file() end,                            desc = "历史记录" },
        -- gh
        ...
        { "gr",              function() Snacks.picker.lsp_references() end,                          nowait = true,                       desc = "查看引用" },
        ...
        { "gai",             function() Snacks.picker.lsp_incoming_calls() end,                      desc = "进入的调用" },
        ...
        { "<leader>gB",      function() Snacks.gitbrowse() end,                                      desc = "Git浏览器",                 mode = { "n", "v" } },
